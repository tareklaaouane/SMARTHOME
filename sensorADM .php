...
<a href="./logout.php" class="logo" target="_self">
  ...
  <nav class="nav"> 		
      <ul class="pt-5">
          ...
          <li><a href="./deletesensor.php">DELETE SENSOR</a></li>
          <li><a href="./modifysensor.php">MODIFY SENSOR</a></li>
          <li><a href="./consultsensor.php">CONSULT SENSOR</a></li>
      </ul>
  </nav>

  <div class="section-center">
    <h1 class="mb-0"> ADMIN : SENSOR section</h1>
  </div>